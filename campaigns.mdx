---
title: "Campaigns"
description: "Send structured outreach sequences to groups of contacts. Campaigns let you compose personalized emails, track responses, and measure engagement — all in one place."
---

A campaign is a named outreach sequence you run against a group of contacts. Orbis generates AI-drafted emails for each recipient based on your stated goal, lets you review and send them, and then tracks replies and response rates as they come in.
...
The difference between a campaign and sending emails one by one is tracking. Orbis shows you — per contact — whether an email is drafted, sent, or replied to, and rolls that up into response rate metrics across the whole campaign.
...
<Note>
  Reply tracking requires a connected Gmail account. Replies are detected by matching the original email's message thread ID.
</Note>
